...
Figure 5.3 plots significant coefficients for the external factors thought to affect an agent's self-employment entry. Here, we note more pronounced effects of the gender split, with most covariates affecting men or women significantly, but not both groups. 
