...
\begin{sidewaysfigure}
    \centering{%
		    \includegraphics[width=1\linewidth]{ch-results/significant_all.png}%
       	}%
...
\begin{figure}[hbtp]
	  \centering{%
		  \includegraphics[width=0.5\linewidth]{ch-results/industry_f.png}%
    	}%
...
\begin{figure}[hbtp]
	  \centering{%
		  \includegraphics[width=0.5\linewidth]{ch-results/industry_gen.png}%
    	}%
...
\begin{figure}[hbtp]
	  \centering{%
		  \includegraphics[width=0.5\linewidth]{ch-results/industry_m.png}%
    	}%
